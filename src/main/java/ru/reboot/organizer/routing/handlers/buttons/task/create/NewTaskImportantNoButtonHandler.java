...
public class NewTaskImportantNoButtonHandler implements ButtonHandler {
    ...
    public ButtonType getHandledButton() {
        return ButtonType.NEW_TASK_IMPORTANT_NO;
    }

    @Override
    public UnifiedResponse handleButton(Long userId, String payload) {
        taskService.createTaskFromDraft(userId, false);
