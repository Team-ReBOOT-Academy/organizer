...
public class TaskToggleCompletedButtonHandler implements ButtonHandler {
    private final TaskService taskService;
    private final ViewTaskButtonHandler viewTaskButtonHandler;

    @Override
    public ButtonType getHandledButton() {
        return ButtonType.TASK_TOGGLE_COMPLETED;
    }

    @Override
    public UnifiedResponse handleButton(Long userId, String payload) {
        String taskIdStr = payload.replace(ButtonType.TASK_TOGGLE_COMPLETED.getPayload(), "");
